    ...
    <motion.nav
      ...
      className="fixed top-0 w-full z-50 flex justify-between items-center px-8 py-6 bg-glass backdrop-blur-md border-b border-white/10">
            ...
            <div className="flex gap-6">
                <Link to="/" onMouseEnter={() => playHover()} className="hover:text-primary transition-colors">Home</Link>
                <Link to="/about" onMouseEnter={() => playHover()} className="hover:text-primary transition-colors">About</Link>
                <Link to="/projects" onMouseEnter={() => playHover()} className="hover:text-primary transition-colors">Projects</Link>
                <Link to="/journey" onMouseEnter={() => playHover()} className="hover:text-primary transition-colors">Journey</Link>
            </div>
